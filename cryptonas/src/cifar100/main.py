...
from src.cifar100.data_utils import read_data
...
DEFINE_boolean("controller_no_skip", False, "")
...
def get_ops(images, labels):
  ...
  if FLAGS.child_fixed_arc is None:
    controller_model = ControllerClass(
      ...
      no_skip=FLAGS.controller_no_skip)
  ...
  child_ops = {
    ...
    "relu_size": child_model.relu_size,
  }
...
def train():
  if FLAGS.child_fixed_arc is None:
    ...
    images, labels = read_data(FLAGS.data_path, resolution=FLAGS.resolution, num_valids=0)
    ...
    #    sess = tf_debug.LocalCLIDebugWrapperSession(sess)
        ...
        while True:
          ...
          if actual_step % ops["eval_every"] == 0:
            ...
            curr_tst_time=time.time()
            print("test_time: {:.4f}".format(float(curr_tst_time-tst_time)/60))
